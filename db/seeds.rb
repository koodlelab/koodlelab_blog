...
@sample_body = "<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus, vero, obcaecati, aut, error quam sapiente nemo saepe quibusdam sit excepturi nam quia corporis eligendi eos magni recusandae laborum minus inventore?</p>
...
Blog.create!(title: 'Testing Blogs',
    body: @sample_body)

99.times do |n|
  Blog.create!(title: "Testing Blogs #{n}",
             body: @sample_body)
end

User.create!(user_name:"koodlela", password: "koodlela123", password_confirmation: "koodlela123")